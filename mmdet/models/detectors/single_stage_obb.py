...
class SingleStageDetector_obb(BaseDetector):
    ...
    def __init__(self,
        ...
        super(SingleStageDetector_obb, self).__init__(init_cfg)
        if pretrained:
    ...
    def forward_train(self,
        ...
        """
        super(SingleStageDetector_obb, self).forward_train(img, img_metas)
        x = self.extract_feat(img)
